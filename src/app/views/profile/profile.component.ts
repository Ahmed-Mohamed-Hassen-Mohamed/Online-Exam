      ...
      next: (exams: any) => {
        for (let exam of exams) {
          let myPromise = new Promise(async (resolve, reject) => {
            this.examService.getMyAnswers(exam.exam._id).subscribe({
              next: (answers: any) => {
                let mark = 0;
          ...
          myPromise.then(async (mark: any) => {
            this.examService.getCountDocuments(exam.exam._id).subscribe({
              next: (countDocuments: any) => {
                exam.mark = (mark / countDocuments.countQuestions).toFixed(2);
              },
            });
          });
